...
export const openOppurtunityTitle = StyleSheet.create({
    ...
    export const cardContentopenEvent = () => {

        return StyleSheet.create({
            flexDirection: 'row', width: width - 25, height: height / 6, borderWidth: 2, borderColor: 'white', backgroundColor: 'white', borderRadius: 13,
            shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.8, shadowRadius: 2, elevation: 5, marginLeft: 12
        });
    };

    export const cardContentopenEventIcon = (color) => {
