    ...
    return (
        <View style={HomeStyles.openOppurtunityOuterView}>
            ...
            <Text style={HomeStyles.openOppurtunityTitle}>
                Participation Rate In Events
            </Text>


            <ClosedOpportunityCard navigation={navigation} color={'#4ecf9d'} title={'Fligth'} text={21} />
            {/* offer card  */}
            <ClosedOpportunityCard navigation={navigation} color={'#e6c67a'} title={'Coffee'} text={15} />
            {/* extra time card  */}
            <ClosedOpportunityCard navigation={navigation} color={'#4b92d9'} title={'Education'} text={3} />
            {/* lose card  */}
        </View>
    );
}
